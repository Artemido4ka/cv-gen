...
@Component({
  ...
  styleUrls: ['./old-select.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => OldSelectComponent), multi: true },
  ],
})
export class OldSelectComponent implements ControlValueAccessor, OnInit {
